...
export const metadata: Metadata = {
  ...
  description:
    'Plataforma completa de marketplace B2B e B2C para o agronegócio. Encontre produtos, fornecedores e serviços agrícolas.',
};

const categories = [
  { name: 'Insumos', slug: 'insumos', count: 234, icon: Sprout },
  { name: 'Máquinas', slug: 'maquinas', count: 156, icon: Wheat },
  { name: 'Sementes', slug: 'sementes', count: 189, icon: Leaf },
  { name: 'Fertilizantes', slug: 'fertilizantes', count: 312, icon: Sun },
  { name: 'Defensivos', slug: 'defensivos', count: 178, icon: Shield },
  { name: 'Irrigação', slug: 'irrigacao', count: 95, icon: Wind },
  { name: 'Pecuária', slug: 'pecuaria', count: 267, icon: Store },
  { name: 'Armazenagem', slug: 'armazenagem', count: 143, icon: Truck },
];

const featuredProducts = [
  { id: '1', name: 'Trator Agrícola 4x4', slug: 'trator-agricola-4x4', price: 249900, image: '/images/products/trator.jpg', supplier: 'Máquinas Agrícolas LTDA', rating: 4.8, reviews: 42 },
  { id: '2', name: 'Fertilizante NPK 10-10-10', slug: 'fertilizante-npk', price: 18990, image: '/images/products/fertilizante.jpg', supplier: 'AgroQuímica Brasil', rating: 4.6, reviews: 128 },
  { id: '3', name: 'Semente de Soja RR', slug: 'semente-soja-rr', price: 34990, image: '/images/products/semente.jpg', supplier: 'Sementes Selecta', rating: 4.9, reviews: 87 },
  { id: '4', name: 'Sistema de Irrigação por Gotejo', slug: 'irrigacao-gotejo', price: 15990, image: '/images/products/irrigacao.jpg', supplier: 'TechIrriga', rating: 4.7, reviews: 56 },
];

const topSuppliers = [
  { id: '1', name: 'AgroQuímica Brasil', logo: '/images/suppliers/agroquimica.jpg', rating: 4.8, city: 'Ribeirão Preto', state: 'SP', products: 342 },
  { id: '2', name: 'Máquinas Agrícolas LTDA', logo: '/images/suppliers/maquinas.jpg', rating: 4.6, city: 'Londrina', state: 'PR', products: 89 },
  { id: '3', name: 'Sementes Selecta', logo: '/images/suppliers/selecta.jpg', rating: 4.9, city: 'Cuiabá', state: 'MT', products: 156 },
  { id: '4', name: 'TechIrriga', logo: '/images/suppliers/techirriga.jpg', rating: 4.7, city: 'Campinas', state: 'SP', products: 67 },
  { id: '5', name: 'Defensivos AgroFort', logo: '/images/suppliers/agrofort.jpg', rating: 4.5, city: 'Uberlândia', state: 'MG', products: 203 },
  { id: '6', name: 'Pecuária Brasil', logo: '/images/suppliers/pecuaria.jpg', rating: 4.7, city: 'Campo Grande', state: 'MS', products: 178 },
];
            ...
            {categories.map((cat) => (
              ...
              >
                ...
                <div className="text-center">
                  ...
                  <p className="text-xs text-gray-500">{cat.count} itens</p>
                </div>
              </Link>
            ))}
          </div>
            ...
            {topSuppliers.map((supplier) => (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400">{supplier.city}, {supplier.state}</p>
