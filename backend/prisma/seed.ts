...
const SUPPLIERS = [
  ...
  { companyName: 'Sementes Silva', tradingName: 'Sementes Silva', email: 'vendas@sementessilva.com', user: 'Pedro Silva', document: '00.000.002/0001-02', phone: '(11) 92222-2222', city: 'Londrina', state: 'PR', category: 'sementes', status: SupplierStatus.APPROVED, rating: 4.8, products: 48 },
  { companyName: 'Agro Tech Ltda', tradingName: 'AgroTech', email: 'admin@agrotech.com', user: 'Roberto Lima', document: '00.000.003/0001-03', phone: '(11) 93333-3333', city: 'Campinas', state: 'SP', category: 'implementos', status: SupplierStatus.APPROVED, rating: 4.6, products: 24 },
  { companyName: 'Fertilizantes ABC', tradingName: 'Fert ABC', email: 'contato@fertabc.com', user: 'Fernando Costa', document: '00.000.004/0001-04', phone: '(11) 94444-4444', city: 'Uberlândia', state: 'MG', category: 'fertilizantes', status: SupplierStatus.PENDING, rating: 0, products: 15 },
  { companyName: 'Fazenda Boa Vista', tradingName: 'Boa Vista', email: 'contato@boavista.com', user: 'Juliana Campos', document: '00.000.005/0001-05', phone: '(11) 95555-5555', city: 'Campo Grande', state: 'MS', category: 'diversos', status: SupplierStatus.PENDING, rating: 0, products: 0 },
  { companyName: 'IrrigaFácil', tradingName: 'IrrigaFácil', email: 'vendas@irrigafacil.com', user: 'André Oliveira', document: '00.000.006/0001-06', phone: '(11) 96666-6666', city: 'Campinas', state: 'SP', category: 'irrigacao', status: SupplierStatus.APPROVED, rating: 4.9, products: 32 },
  { companyName: 'Máquinas Agrícolas LTDA', tradingName: 'Máq. Agrícolas', email: 'contato@maquinasagri.com', user: 'Marcos Santos', document: '00.000.007/0001-07', phone: '(11) 97777-7777', city: 'Cuiabá', state: 'MT', category: 'maquinas', status: SupplierStatus.APPROVED, rating: 4.5, products: 18 },
  { companyName: 'Defensivos Nacional', tradingName: 'Def. Nacional', email: 'pedidos@defensivosnac.com', user: 'Paulo Rocha', document: '00.000.008/0001-08', phone: '(21) 98888-8888', city: 'Goiânia', state: 'GO', category: 'defensivos', status: SupplierStatus.APPROVED, rating: 4.7, products: 56 },
  { companyName: 'Sementes Genetix', tradingName: 'Genetix', email: 'comercial@sementesgenetix.com', user: 'Luiz Mendes', document: '00.000.009/0001-09', phone: '(21) 99999-9999', city: 'Passo Fundo', state: 'RS', category: 'sementes', status: SupplierStatus.APPROVED, rating: 4.9, products: 34 },
  { companyName: 'AgroTec Sistemas', tradingName: 'AgroTec', email: 'vendas@agrotecsistemas.com', user: 'Tiago Barbosa', document: '00.000.010/0001-10', phone: '(31) 91111-1111', city: 'Sorriso', state: 'MT', category: 'tecnologia', status: SupplierStatus.APPROVED, rating: 4.3, products: 12 },
  { companyName: 'Pecuária Forte', tradingName: 'Pec. Forte', email: 'contato@pecuariaforte.com', user: 'Gustavo Pereira', document: '00.000.011/0001-11', phone: '(31) 92222-2222', city: 'Campo Grande', state: 'MS', category: 'pecuaria', status: SupplierStatus.APPROVED, rating: 4.5, products: 24 },
  { companyName: 'Transporte Rural Log', tradingName: 'Rural Log', email: 'logistica@transporterural.com', user: 'Ricardo Teixeira', document: '00.000.012/0001-12', phone: '(41) 91111-1111', city: 'Ribeirão Preto', state: 'SP', category: 'logistica', status: SupplierStatus.APPROVED, rating: 4.2, products: 5 },
  { companyName: 'Armazenagem Total', tradingName: 'Arm. Total', email: 'admin@armazenagemtotal.com', user: 'Fábio Carvalho', document: '00.000.013/0001-13', phone: '(41) 92222-2222', city: 'Passo Fundo', state: 'RS', category: 'armazenagem', status: SupplierStatus.APPROVED, rating: 4.4, products: 9 },
  { companyName: 'Orgânicos do Vale', tradingName: 'Org. Vale', email: 'contato@organicosdovale.com', user: 'Marina Duarte', document: '00.000.014/0001-14', phone: '(51) 91111-1111', city: 'Londrina', state: 'PR', category: 'organicos', status: SupplierStatus.PENDING, rating: 0, products: 0 },
  { companyName: 'BioDefensivos Naturais', tradingName: 'BioDef.', email: 'pedidos@biodefensivos.com', user: 'Rafael Nunes', document: '00.000.015/0001-15', phone: '(51) 92222-2222', city: 'Uberlândia', state: 'MG', category: 'defensivos', status: SupplierStatus.APPROVED, rating: 4.6, products: 22 },
  { companyName: 'Tratores e Cia', tradingName: 'Tratores Cia', email: 'vendas@tratoresecia.com', user: 'Diego Martins', document: '00.000.016/0001-16', phone: '(61) 91111-1111', city: 'Cuiabá', state: 'MT', category: 'maquinas', status: SupplierStatus.APPROVED, rating: 4.5, products: 14 },
  { companyName: 'IrrigaTech Solutions', tradingName: 'IrrigaTech', email: 'suporte@irrigatech.com', user: 'Eduardo Araújo', document: '00.000.017/0001-17', phone: '(61) 92222-2222', city: 'Sorriso', state: 'MT', category: 'irrigacao', status: SupplierStatus.BLOCKED, rating: 4.7, products: 28 },
  { companyName: 'NutriPlant Fertilizantes', tradingName: 'NutriPlant', email: 'admin@nutriplant.com', user: 'Bruno Ferreira', document: '00.000.018/0001-18', phone: '(71) 91111-1111', city: 'Goiânia', state: 'GO', category: 'fertilizantes', status: SupplierStatus.APPROVED, rating: 4.8, products: 41 },
];
...
async function main() {
  ...
  for (const s of SUPPLIERS) {
    const user = await prisma.user.upsert({
      ...
      create: {
        ...
        verified: s.status === SupplierStatus.APPROVED,
      },
    });
    ...
    const profile = await prisma.supplierProfile.upsert({
      ...
      create: {
        ...
        featured: s.status === SupplierStatus.APPROVED && s.rating >= 4.5,
        businessHours: {
  ...
  // Categorias e tipos de suporte (Relatar Problema)
  interface SupportCategorySeed {
    slug: string;
    name: string;
    description: string;
    icon: string;
  ...
  const SUPPORT_CATEGORIES: SupportCategorySeed[] = [
